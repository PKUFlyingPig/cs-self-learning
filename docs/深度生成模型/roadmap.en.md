...
- [CMU 10-799: Diffusion & Flow Matching](./CMU10-799.md): A seven-week CMU Spring 2026 course spanning DDPM, score-based SDEs, Flow Matching, fast sampling, controllable generation, distillation, and discrete generation, with public recordings, slides, four assignments, and starter code.
