...
- [MIT 6.S183: A Practical Introduction to Diffusion Models](./MIT6.S183.md): A hands-on MIT IAP 2026 diffusion course with six public lectures, two problem sets, a mini project, and the lightweight `smalldiffusion` teaching code. It complements the more mathematical perspective of MIT 6.S184.
...
- [Stanford CS236: Deep Generative Models](https://deepgenerativemodels.github.io/): A classic Stanford course taught by Stefano Ermon. Starting from Autoregressive Models and Maximum Likelihood Learning, it systematically covers VAEs, Normalizing Flows, GANs, EBMs, Score-based Models, and Diffusion Models. Compared with MIT 6.S184, CS236 takes a more probabilistic modeling perspective and derives recurring concepts such as the ELBO, Change of Variables, and Score Matching from first principles. There is a fair amount of math, but the course progresses naturally. If you want to understand why different generative models are designed the way they are rather than merely knowing how to train a Diffusion Model, this is an excellent course to follow end-to-end.
