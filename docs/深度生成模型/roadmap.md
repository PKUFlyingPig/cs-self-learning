...
- [CMU 10-799: Diffusion & Flow Matching](./CMU10-799.md): CMU Spring 2026 的 7 周专题课，从 DDPM、score-based SDE 和 Flow Matching 延伸到快速采样、可控生成、蒸馏与离散生成；录像、课件、四次作业和 starter code 均公开。
