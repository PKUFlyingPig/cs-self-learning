...
随着modern C++的发展，这门课也在与时俱进，Fall25的版本与PKUFlyingPig的版本区别已经很大了，主要是在Assignment方面：

最近几年的版本基本都是有7个Assignments，其中A0为Setup，剩余6个为代码作业。每个代码作业都比较短小精悍，提供了大部分的代码框架，意在让学生简单实践上课所学的知识，内容大致如下：
...
课程的slides也很适合自学，读slide+配合LLM问问题个人认为完全足够了。
